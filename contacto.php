...
h2
{
	...
	/*text-shadow: -5px 2px 0px rgba(0,0,0,0.27);*/
}
...
<nav>
    <ul>
        ...
        <li>
        	<a href="#">Propuestas<span class="icon-circle-down"></span><span class="icon-circle-up"></span> </a>
        ...
        <li>
        	<a class="actual" href="contacto.php">Contacto</a>
        </li>
    </ul>
</nav>
...
<form id="idformulario"   name="sformulario" method='POST' action="correo.php" enctype="multipart/form-data">
...
<input type="text" id="nombre" name="snombre" placeholder="Nombre...." autocomplete="off" required>
</div>
...
<input type="text" id="apellido" name="sapellido" placeholder="Nombre...." autocomplete="off" required>
</div>
...
<input type="text" id="telefono" name="stelefono" placeholder="Telefono...." autocomplete="off" required>
</div>

<div class="div_form">
<label for='email'>email</label>
<input type="email" id="email" name="semail" autocomplete="off" placeholder="email...." required step="any"> 
</div>



<div class="div_form">
<label for='cantidad'>N° de Personas </label>
<input type="number" id="cantidad" name="scantidad" autocomplete="off" required step="any" min="0" max="83">
</div>

<div>
<textarea name="scomentario" placeholder="Escribe tu comentario...." rows="10" cols="40"></textarea>
</div>

<div class="div_form">
<input type="submit" id="enviar" name="senviar" value="Enviar">
</div>
...
<!--<script type="text/javascript" src="https://form.jotform.com/jsform/212256706472354"></script>-->


<!--<script type="text/javascript" src="https://form.jotform.com/jsform/212342945090351"></script>-->
...
<script src="https://cdn02.jotfor.ms/static/jotform.forms.js?3.3.27226" type="text/javascript"></script>
...
if (window.JotForm && JotForm.accessible) $('input_17').setAttribute('tabindex',0);
    ...
    (function init(props) {
	  ...
	  return _update;
	})({"text":{"text":"Question","value":"Reserva"},"labelAlign":{"text":"Label Align","value":"Top","dropdown":[["Auto","Auto"],["Left","Left"],["Right","Right"],["Top","Top"]]},"required":{"text":"Required","value":"No","dropdown":[["No","No"],["Yes","Yes"]]},"description":{"text":"Hover Text","value":"","textarea":true},"slotDuration":{"text":"Slot Duration","value":"90","dropdown":[[15,"15 min"],[30,"30 min"],[45,"45 min"],[60,"60 min"],["custom","Custom min"]],"hint":"Select how long each slot will be."},"startDate":{"text":"Start Date","value":""},"endDate":{"text":"End Date","value":""},"intervals":{"text":"Intervals","value":[{"from":"11:00","to":"23:00","days":["Mon","Tue","Wed","Thu","Fri","Sat","Sun"]}],"hint":"The hours will be applied to the selected days and repeated."},"useBlockout":{"text":"Blockout Custom Dates","value":"No","dropdown":[["No","No"],["Yes","Yes"]],"hint":"Disable certain date(s) in the calendar."},"blockoutDates":{"text":"Blockout dates","value":[{"startDate":"","endDate":""}]},"useLunchBreak":{"text":"Lunch Time","value":"No","dropdown":[["No","No"],["Yes","Yes"]],"hint":"Enable lunchtime in the calendar."},"lunchBreak":{"text":"Lunchtime hours","value":[{"from":"12:00","to":"14:00"}]},"timezone":{"text":"Timezone","value":"Europe/Madrid (GMT+02:00)"},"timeFormat":{"text":"Time Format","value":"24 Hour","dropdown":[["24 Hour","24 Hour"],["AM/PM","AM/PM"]],"icon":"images/blank.gif","iconClassName":"toolbar-time_format_24"},"months":{"value":["January","February","March","April","May","June","July","August","September","October","November","December"],"hidden":true},"days":{"value":["Monday","Tuesday","Wednesday","Thursday","Friday","Saturday","Sunday"],"hidden":true},"startWeekOn":{"text":"Start Week On","value":"Monday","dropdown":[["Monday","Monday"],["Sunday","Sunday"]],"toolbar":false},"rollingDays":{"text":"Rolling Days","value":"","toolbar":false},"prevMonthButtonText":{"text":"Previous month","value":""},"nextMonthButtonText":{"text":"Next month","value":""},"prevYearButtonText":{"text":"Previous year","value":""},"nextYearButtonText":{"text":"Next year","value":""},"prevDayButtonText":{"text":"Previous day","value":""},"nextDayButtonText":{"text":"Next day","value":""},"appointmentType":{"hidden":true,"value":"multiple"},"dateFormat":{"hidden":true,"value":"dd/mm/yyyy"},"maxAttendee":{"hidden":true,"value":"5"},"minScheduleNotice":{"hidden":true,"value":"3"},"name":{"hidden":true,"value":"reserva"},"order":{"hidden":true,"value":"5"},"qid":{"toolbar":false,"value":"input_24"},"type":{"hidden":true,"value":"control_appointment"},"id":{"toolbar":false,"value":"24"},"qname":{"toolbar":false,"value":"q24_reserva"},"cdnconfig":{"CDN":"https://cdn.jotfor.ms/"},"passive":false,"formProperties":{"products":false,"highlightLine":"Enabled","coupons":false,"useStripeCoupons":false,"taxes":false,"comparePaymentForm":"","paymentListSettings":false,"newPaymentUIForNewCreatedForms":false,"formBackground":"#fff"},"formID":212342945090351,"themeVersion":"v2"});
   ...
   JotForm.prepareCalculationsOnTheFly([null,{"name":"reserva1","qid":"1","text":"reserva","type":"control_button"},null,null,null,null,{"name":"telefono","qid":"6","text":"Telefono","type":"control_textbox"},null,null,null,null,null,null,null,null,null,null,{"name":"comensales","qid":"17","text":"Comensales","type":"control_textbox"},{"name":"mesaDe","qid":"18","text":"Mesa de reserva","type":"control_head"},null,{"name":"fullName20","qid":"20","text":"Full Name","type":"control_fullname"},null,null,null,{"name":"reserva","qid":"24","text":"Reserva","type":"control_appointment"}]);
   setTimeout(function() {
JotForm.paymentExtrasOnTheFly([null,{"name":"reserva1","qid":"1","text":"reserva","type":"control_button"},null,null,null,null,{"name":"telefono","qid":"6","text":"Telefono","type":"control_textbox"},null,null,null,null,null,null,null,null,null,null,{"name":"comensales","qid":"17","text":"Comensales","type":"control_textbox"},{"name":"mesaDe","qid":"18","text":"Mesa de reserva","type":"control_head"},null,{"name":"fullName20","qid":"20","text":"Full Name","type":"control_fullname"},null,null,null,{"name":"reserva","qid":"24","text":"Reserva","type":"control_appointment"}]);}, 20); 
</script>
...
<link type="text/css" rel="stylesheet" href="https://cdn02.jotfor.ms/css/styles/payment/payment_styles.css?3.3.27226" />
<link type="text/css" rel="stylesheet" href="https://cdn03.jotfor.ms/css/styles/payment/payment_feature.css?3.3.27226" />
...
<form class="jotform-form" action="https://submit.jotformeu.com/submit/212342945090351/" method="post" name="form_212342945090351" id="212342945090351" accept-charset="utf-8" autocomplete="on">
  <input type="hidden" name="formID" value="212342945090351" />
  <input type="hidden" id="JWTContainer" value="" />
  <input type="hidden" id="cardinalOrderNumber" value="" />
  <div role="main" class="form-all">
    <link type="text/css" rel="stylesheet" media="all" href="https://cdn.jotfor.ms/wizards/languageWizard/custom-dropdown/css/lang-dd.css?3.3.27226" />
    <div class="cont">
    ...
    <script type="text/javascript" src="https://cdn.jotfor.ms/js/formTranslation.v2.js?3.3.27226"></script>
    <style>
      ...
      <li id="cid_18" class="form-input-wide" data-type="control_head">
        <div class="form-header-group  header-large">
          <div class="header-text httal htvam">
            <h4 id="header_18" class="form-header" data-component="header">
              Mesa de reserva
            </h4>
            <div id="subHeader_18" class="form-subHeader">
              Por favor, complete el formulario a continuación con precisión para que podamos brindarle un mejor servicio. ¡Bienvenido!
            </div>
          </div>
        </div>
      </li>
      <li class="form-line" data-type="control_fullname" id="id_20">
        <label class="form-label form-label-left form-label-auto" id="label_20" for="first_20"> Datos </label>
        <div id="cid_20" class="form-input" data-layout="full">
          <div data-wrapper-react="true">
            <span class="form-sub-label-container" style="vertical-align:top" data-input-type="first">
              <input type="text" id="first_20" name="q20_fullName20[first]" class="form-textbox" size="10" value="" data-component="first" aria-labelledby="label_20 sublabel_20_first" />
              <label class="form-sub-label" for="first_20" id="sublabel_20_first" style="min-height:13px" aria-hidden="false"> Nombre </label>
            </span>
            <span class="form-sub-label-container" style="vertical-align:top" data-input-type="last">
              <input type="text" id="last_20" name="q20_fullName20[last]" class="form-textbox" size="15" value="" data-component="last" aria-labelledby="label_20 sublabel_20_last" />
              <label class="form-sub-label" for="last_20" id="sublabel_20_last" style="min-height:13px" aria-hidden="false"> Apellido</label>
            </span>
          </div>
        </div>
      </li>
      <li class="form-line" data-type="control_textbox" id="id_6">
        <label class="form-label form-label-left form-label-auto" id="label_6" for="input_6"> Teléfono </label>
        <div id="cid_6" class="form-input" data-layout="half">
          <input type="text" id="input_6" name="q6_telefono" data-type="input-textbox" class="form-textbox" style="width:20px" size="20" value="" maxLength="100" placeholder=" " data-component="textbox" aria-labelledby="label_6" />
        </div>
      </li>
      <li class="form-line" data-type="control_textbox" id="id_17">
        <label class="form-label form-label-left form-label-auto" id="label_17" for="input_17"> Comensales </label>
        <div id="cid_17" class="form-input" data-layout="half">
          <input type="text" id="input_17" name="q17_comensales" data-type="input-textbox" class="form-textbox validate[Numeric]" style="width:3px" size="3" value="" maxLength="100" placeholder=" " data-component="textbox" aria-labelledby="label_17" />
        </div>
      </li>
      <li class="form-line" data-type="control_appointment" id="id_24">
        <label class="form-label form-label-top" id="label_24" for="input_24"> Reserva </label>
        <div id="cid_24" class="form-input-wide" data-layout="full">
          <div id="input_24" class="appointmentFieldWrapper jfQuestion-fields">
            <input class="appointmentFieldInput " name="q24_reserva[date]" id="input_24_date" />
            <input class="appointmentFieldInput" name="q24_reserva[duration]" value="90" id="input_24_duration" />
            <input class="appointmentFieldInput" name="q24_reserva[timezone]" value="Europe/Madrid (GMT+02:00)" id="input_24_timezone" />
  ...
  <input type="hidden" class="simple_spc" id="simple_spc" name="simple_spc" value="212342945090351" />
  <script type="text/javascript">
  var all_spc = document.querySelectorAll("form[id='212342945090351'] .si" + "mple" + "_spc");
for (var i = 0; i < all_spc.length; i++)
{
  all_spc[i].value = "212342945090351-212342945090351";
}
  </script>
  ...
  <div class="formFooter f6">
    <div class="formFooter-wrapper formFooter-leftSide">
      <a href="https://www.jotform.com/?utm_source=formfooter&utm_medium=banner&utm_term=212342945090351&utm_content=jotform_logo&utm_campaign=powered_by_jotform_le" target="_blank" class="formFooter-logoLink"><img class="formFooter-logo" src="https://cdn.jotfor.ms/assets/img/logo/logo-new@1x.png" alt="Jotform Logo"></a>
    </div>
    <div class="formFooter-wrapper formFooter-rightSide">
      <span class="formFooter-text">
        Now create your own JotForm - It's free!
      </span>
      <a class="formFooter-button" href="https://www.jotform.com/?utm_source=formfooter&utm_medium=banner&utm_term=212342945090351&utm_content=jotform_button&utm_campaign=powered_by_jotform_le" target="_blank">Create your own JotForm</a>
    </div>
  </div>
</form>
...
<form id="contacto"   name="sformulario" method='POST' action='php/1_alta_reserva.php'enctype="multipart/form-data">
...
<label class="labellll" for='nombre'> Nombre  </label> <span class="rojo">*</span>
<input class="innnnnputttt" type="text" id="nombre" name="snombre" placeholder="Nombre..." autocomplete="off" required>

<label class="labellll" for='telefono'>Telefono </label> <span class="rojo">*</span>
<input class="innnnnputttt" type="text" id="telefono" name="stelefono" placeholder="Telefono...." autocomplete="off" required>
...
<label class="labellll" for='cantidad'>Comensales </label><span class="rojo">*</span>
<input class="innnnnputttt" type="number" id="cantidad" name="scomensales" placeholder="Favor ingrese un Numero..." autocomplete="off" required step="any" min="0" max="12">



<label class="labellll" for='fecha'>Fecha</label><span class="rojo">*</span>
<input class="innnnnputttt" type="date" name="sfecha" id="fecha" min="2021-08-10" max="2021-08-31" step="1" />


<label class="labellll" for='hora'>Hora</label><span class="rojo">*</span>
<input class="innnnnputttt" type="time" name="shora" id="hora" value="12:00" max="22:30" min="12:00"/>



<label class="labellll" for="textarea"> Comentarios </label> <span class="rojo">*</span>
<textarea id="textarea" name="stextarea" placeholder="Comentarios..." minlength="10" maxlength="350" size="10" ></textarea>

<div>
<input class="innnnnputttt" type="submit" id="aceptar" name="senviar" value="Aceptar">
</div>
...
<form id="contacto"   name="sformulario" method='POST' action='php/comentarios.php'enctype="multipart/form-data">
...
<label class="labellll" for="textarea"> Comentarios </label> <span class="rojo">*</span>
<textarea id="textarea" name="stextarea" placeholder="Comentarios..." minlength="10" maxlength="350" size="10" required></textarea>
...
<span class="rojo">* Campos Obligatorios</span>
   ...
   <!--<form action="correo.php" method="post">
                        ...
                        <textarea name="msg" class="message" placeholder="MENSAJE ... " id="msg"></textarea>
...
<article class="contactanos">
    ...
    <p>		<span class="icon-whatsapp1">		+34 000 00 000								</span>		</p>   
	<p>		<span class="icon-mail-dot-ru">		dsfbdf@bbbb.com							</span>		</p> 
    <p>		<span class="icon-connection">		Free											</span>		</p> 
    <p>		<span class="icon-zingat">			bdfbdfbdfbdfbb, Spain		</span>		</p>
...
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3056.543686398928!2d-0.03954068511930432!3d39.99630168902616!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xd5fffffd069aca3%3A0xb904d379dc50e797!2sBar%20restaurante%20luciano!5e0!3m2!1ses!2ses!4v1640628574688!5m2!1ses!2ses" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
...
<!--<article class="foter_3">
    ...
    <p>		<a class="silver" href="#">		<span class="icon-old-phone">	+34 549 98 09 23		</span>		</a>	</p>    <p>		<a class="silver" href="#">		<span class="icon-location">Plaza del Corro Campios 2, Comillas, Spain</span>		</a>	</p>
